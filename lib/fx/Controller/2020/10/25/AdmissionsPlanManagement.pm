    ...
    if ( $c->req->{"method"} eq "POST" ) {
        ...
        if ($bmkssj ne '' && $bmsjjz ne '') {
            ...
            if ($flag eq 0) { # 更改
                ...
                $sql = "update usr_wfw.T_FX_ZSJH_SJ set BMKSSJ=\'$bmkssj\',BMJZSJ=\'$bmsjjz\', YJDJFKSSJ=\'$yjdks\', YJDJFJZSJ=\'$yjdjz\', EJDJFKSSJ=\'$ejdks\', EJDJFJZSJ=\'$ejdjz\', CJLRKSSJ=\'$cjlrks\', CJLRJZSJ=\'$cjlrjz\', CJBGKSSJ=\'$cjgxks\', CJBGJZSJ=\'$cjgxjz\'";
            }
