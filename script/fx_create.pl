...
Catalyst::ScriptRunner->run('fx', 'Create');

1;

=head1 NAME

fx_create.pl - Create a new Catalyst Component

=head1 SYNOPSIS

fx_create.pl [options] model|view|controller name [helper] [options]
 ...
 Examples:
   ...
   fx_create.pl model AnotherDB DBIC::Schema MyApp::Schema create=static\
